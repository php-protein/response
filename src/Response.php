...
class Response {
    ...
    protected static $headers     = ['Content-Type' => ['text/html; charset=utf-8']];
    protected static $buffer      = null;
    protected static $force_dl    = false;
     ...
     * @method save
     *
     * @return (string|mixed)[] Headers and body of the response
     *
     * @psalm-return array{head:mixed, body:string}
     */
